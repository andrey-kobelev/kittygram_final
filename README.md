#  Проект «Social Kitties»  
  
> Проект Social Kitties позволяет пользователям поделиться своим пушистым другом

Проект представляет из себя: SPA на React. Я написал бэкенд на Django и REST API на DRF. Реализовал работу с пользователями при помощи djoser и возможность аутентификации по токенам при помощи djoser и Authtoken.  Проект упаковал в docker-контейнера и настроил CI/CD (Git Actions).
